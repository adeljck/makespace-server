...
type UserForgetChangePassword struct {
...
func (service *UserForgetChangePassword) valid() *serializer.Response {
...
func (service *UserForgetChangePassword) Change(id string) (*serializer.PureErrorResponse, *serializer.Response) {
