...
func (service *ProjectDelete) Delete(id string) (*serializer.Response, *serializer.PureErrorResponse) {
	...
	_, err = module.CLIENT.Mongo.Database("makespace").Collection("projects").DeleteOne(context.TODO(), bson.M{"_id": oid})
	if err != nil {
		return nil, &serializer.PureErrorResponse{
			Status: 4003,
			Msg:    "failed",
